...
@Mixin(targets = "mezz.jei.library.plugins.vanilla.anvil.SmithingCategoryExtension")
public abstract class SmithingCategoryExtensionMixin {

	@CompatibleHashes(values = {-981951451})
