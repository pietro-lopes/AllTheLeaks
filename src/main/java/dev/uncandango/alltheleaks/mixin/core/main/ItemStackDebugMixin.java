...
public class ItemStackDebugMixin implements Lockable {
	...
	private void safeSetCount(int count, Operation<Void> original){
		if (!isLocked()) {
			...
			var error = new UnsupportedOperationException("An Ingredient that contains this itemstack was cached and locked by mod AllTheLeaks, modifications of ItemStacks in Ingredients are not allowed!");
