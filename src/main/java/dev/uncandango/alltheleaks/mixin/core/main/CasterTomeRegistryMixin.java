...
public class CasterTomeRegistryMixin {
	...
	private static <E> boolean atl$replaceWithSafeRegistry(List<Supplier<ItemStack>> instance, E e, Operation<Boolean> original, @Local(argsOnly = true) Level level, @Local CasterTomeData tome){
		var registry = level.registryAccess();
		return instance.add(() -> tome.getResultItem(registry));
	}
}
