...
@Issue(modId = "supplementaries", versionRange = "[1.21-3.1.8,1.21-3.5.0)")
public class UntrackedIssue003 {
	...
	static {
		var dummy = ReflectionHelper.getMethodFromClass(WaySignStructure.class, "clearCache", MethodType.methodType(void.class), true);
	}
